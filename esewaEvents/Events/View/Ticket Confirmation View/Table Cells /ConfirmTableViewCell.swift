...
class ConfirmTableViewCell: UITableViewCell {
    ...
    @objc private func confirmButtonAction() {
        ...
        if let rootViewController = currentWindow.rootViewController {
            rootViewController.present(confirmationAlert, animated: true, completion: nil)
        }
    }
    ...
    private func showSuccessAlert() {
        ...
        if let rootViewController = currentWindow.rootViewController {
            rootViewController.present(successAlert, animated: true, completion: nil)
        }
    }
}
